...
example : Term [NatTy] (NatTy >> NatTy)
example = Lambda NatTy (Var 0)

example2 : Term [BoolTy] (NatTy >> BoolTy)
example2 = Lambda NatTy (Var 1)

appl : Term [(NatTy >> BoolTy), NatTy] BoolTy
appl = App (Var 0) (Var 1)

public export
data TyEq : Ty -> Ty -> Type where
  TyRefl : TyEq ty ty
  PiCong : TyEq a a' -> TyEq b b' -> TyEq (a >> b) (a' >> b')

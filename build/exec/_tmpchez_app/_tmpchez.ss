#!/nix/store/lwwj72q1mak7nbf51sgg129zdg3aj09k-chez-scheme-10.2.0/bin/scheme --program
...
(define Int-u--show_Show_Level (lambda (arg-0) (cond ((equal? arg-0 0) "0")(else (let ((e-0 (- arg-0 1))) (string-append "S(" (string-append (Int-u--show_Show_Level e-0) ")")))))))
(define Int-u--show_Show_Ty (lambda (arg-0) (case (vector-ref arg-0 0) ((0) (let ((e-0 (vector-ref arg-0 1))) (string-append "Uni " (Int-u--show_Show_Level e-0)))) ((1) "Nat") ((2) "Boool") (else (let ((e-1 (vector-ref arg-0 1))) (let ((e-2 (vector-ref arg-0 2))) (string-append (Int-u--show_Show_Ty e-1) (string-append ">>" (Int-u--show_Show_Ty e-2)))))))))
...
(define Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 (lambda (arg-3) (case (vector-ref arg-3 0) ((0) (let ((e-2 (vector-ref arg-3 1))) (PreludeC-45Show-u--show_Show_Nat e-2))) ((1) (let ((e-5 (vector-ref arg-3 1))) (PreludeC-45Show-u--show_Show_Bool e-5))) ((2) (let ((e-8 (vector-ref arg-3 1))) (let ((e-9 (vector-ref arg-3 2))) (string-append "(" (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-8) (string-append " + " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-9) ")"))))))) ((3) (let ((e-12 (vector-ref arg-3 1))) (let ((e-13 (vector-ref arg-3 2))) (string-append "(" (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-12) (string-append " * " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-13) ")"))))))) ((4) (let ((e-16 (vector-ref arg-3 1))) (let ((e-17 (vector-ref arg-3 2))) (string-append "(" (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-16) (string-append " && " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-17) ")"))))))) ((5) (let ((e-20 (vector-ref arg-3 1))) (let ((e-21 (vector-ref arg-3 2))) (string-append "(" (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-20) (string-append " || " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-21) ")"))))))) ((6) (let ((e-25 (vector-ref arg-3 1))) (let ((e-26 (vector-ref arg-3 2))) (let ((e-27 (vector-ref arg-3 3))) (string-append "if " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-25) (string-append " then " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-26) (string-append " else " (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-27)))))))))) ((7) (let ((e-30 (vector-ref arg-3 1))) (string-append "U" (Int-u--show_Show_Level e-30)))) ((8) (let ((e-33 (vector-ref arg-3 2))) (string-append "x" (PreludeC-45Show-u--show_Show_Nat e-33)))) ((9) (let ((e-37 (vector-ref arg-3 1))) (let ((e-38 (vector-ref arg-3 2))) (string-append "\x3bb;" (string-append (Int-u--show_Show_Ty e-37) (string-append ". " (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-38))))))) (else (let ((e-43 (vector-ref arg-3 1))) (let ((e-44 (vector-ref arg-3 2))) (string-append "(" (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-43) (string-append " " (string-append (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-44) ")"))))))))))
(define Int-u--show_Show_C-40ValueC-32C-36tyC-41 (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (let ((e-1 (vector-ref arg-1 1))) (string-append "Uni " (Int-u--show_Show_Level e-1)))) ((1) (let ((e-2 (vector-ref arg-1 1))) (PreludeC-45Show-u--show_Show_Nat e-2))) ((2) (let ((e-3 (vector-ref arg-1 1))) (PreludeC-45Show-u--show_Show_Bool e-3))) (else (let ((e-7 (vector-ref arg-1 1))) (let ((e-8 (vector-ref arg-1 2))) (string-append "lambda " (string-append (Int-u--show_Show_Ty e-7) (string-append "." (Int-u--show_Show_C-40C-40TermC-32C-36cC-41C-32C-36tyC-41 e-8))))))))))
(define Int-lookupEnv (lambda (arg-2 arg-3) (let ((e-3 (car arg-2))) (let ((e-4 (cdr arg-2))) (cond ((equal? arg-3 0) e-3)(else (let ((e-7 (- arg-3 1))) (Int-lookupEnv e-4 e-7))))))))
(define Int-eval (lambda (arg-3 arg-4) (case (vector-ref arg-4 0) ((7) (let ((e-2 (vector-ref arg-4 1))) (vector 0 e-2))) ((8) (let ((e-5 (vector-ref arg-4 2))) (Int-lookupEnv arg-3 e-5))) ((9) (let ((e-9 (vector-ref arg-4 1))) (let ((e-10 (vector-ref arg-4 2))) (vector 3 e-9 e-10 arg-3)))) ((10) (let ((e-15 (vector-ref arg-4 1))) (let ((e-16 (vector-ref arg-4 2))) (let ((sc1 (Int-eval arg-3 e-15))) (let ((e-4 (vector-ref sc1 2))) (let ((e-5 (vector-ref sc1 3))) (let ((u--argVal (Int-eval arg-3 e-16))) (let ((u--extendedEnv (cons u--argVal e-5))) (Int-eval u--extendedEnv e-4))))))))) ((0) (let ((e-19 (vector-ref arg-4 1))) (vector 1 e-19))) ((1) (let ((e-22 (vector-ref arg-4 1))) (vector 2 e-22))) ((2) (let ((e-25 (vector-ref arg-4 1))) (let ((e-26 (vector-ref arg-4 2))) (let ((sc1 (Int-eval arg-3 e-25))) (let ((e-0 (vector-ref sc1 1))) (let ((sc2 (Int-eval arg-3 e-26))) (let ((e-1 (vector-ref sc2 1))) (vector 1 (+ e-0 e-1))))))))) ((3) (let ((e-29 (vector-ref arg-4 1))) (let ((e-30 (vector-ref arg-4 2))) (let ((sc1 (Int-eval arg-3 e-29))) (let ((e-0 (vector-ref sc1 1))) (let ((sc2 (Int-eval arg-3 e-30))) (let ((e-1 (vector-ref sc2 1))) (vector 1 (* e-0 e-1))))))))) ((4) (let ((e-33 (vector-ref arg-4 1))) (let ((e-34 (vector-ref arg-4 2))) (let ((sc1 (Int-eval arg-3 e-33))) (let ((e-0 (vector-ref sc1 1))) (let ((sc2 (Int-eval arg-3 e-34))) (let ((e-1 (vector-ref sc2 1))) (vector 2 (cond ((equal? e-0 1) e-1) (else 0)))))))))) ((5) (let ((e-37 (vector-ref arg-4 1))) (let ((e-38 (vector-ref arg-4 2))) (let ((sc1 (Int-eval arg-3 e-37))) (let ((e-0 (vector-ref sc1 1))) (let ((sc2 (Int-eval arg-3 e-38))) (let ((e-1 (vector-ref sc2 1))) (vector 2 (cond ((equal? e-0 1) 1) (else e-1)))))))))) (else (let ((e-42 (vector-ref arg-4 1))) (let ((e-43 (vector-ref arg-4 2))) (let ((e-44 (vector-ref arg-4 3))) (let ((sc1 (Int-eval arg-3 e-42))) (let ((e-0 (vector-ref sc1 1))) (cond ((equal? e-0 1) (Int-eval arg-3 e-43)) (else (Int-eval arg-3 e-44))))))))))))
(define Int-example (vector 9 (vector 1 ) (vector 8 (cons (vector 1 ) (cons (vector 1 ) '())) 0)))
(define Int-main (let ((u--program (vector 10 Int-example (vector 0 42)))) (let ((u--env (cons (vector 1 1) '()))) (let ((u--result (Int-eval u--env u--program))) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "Result: " (Int-u--show_Show_C-40ValueC-32C-36tyC-41 u--result)) "\xa;") eta-0))))))
...
(PrimIO-unsafePerformIO Int-main)
  (collect 4)
